...
[AddComponentMenu("Interactions/InteractionController2D")]
public class InteractionController2D : MonoBehaviour
{
    ...
    {
        Collider2D[] objects = Physics2D.OverlapCircleAll(player.gameObject.transform.position, interactionRange);
        if (objects.Length > 0)
        {
